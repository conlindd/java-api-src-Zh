...
/*  文件：Mutex.java
/* 
/*  最初由Doug Lea编写并发布到公共领域。这可能被用于任何目的,无论如何没有确认。感谢Sun Microsystems Labs的帮助和支持,以及每个人都贡献,测试和使用此代码。
/* 
 ...
 * <p>
 *  一个简单的非重入互斥锁。锁在施工时是免费的。每个获取获取锁,并且每个释放释放它。释放已经可用的锁没有任何效果。
 * <p>
 ...
 * 这允许极细粒度的锁定,因此增加了潜在的并发性,代价是额外的复杂性和开销,通常只有在极端争用的情况下才有价值。
 * <pre>
