...
class DQTMarkerSegment extends MarkerSegment {
     ...
     * was used.
     * <p>
     *  假设通过缩放"标准"视觉无损亮度表来生成给定表,则提取所使用的比例因子。
     * 
     */
    ...
    class Qtable implements Cloneable {
        ...
        void print() {
            ...
            /*
              ...
              System.out.println();
            /* <p>
            /*  for(int i = 0; i <64; i ++){if(i％8 == 0){System.out.println(); } System.out.print(""+ Integer.toString(data [i])); } System.out.println();。
            */
        }
    }
}
