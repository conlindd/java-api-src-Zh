 ...
 *
 * <p>
 *  这是"标准"解析器配置。它使用标准的解析器组件集合扩展了DTD配置。解析器组件的标准集包括用DTD解析和验证所需的解析器组件,以及XML模式所需的解析器组件。</p>
 * <p>
 *  除了基本解析器配置识别的功能和属性之外,此类还识别这些附加的功能和属性：
 * <ul>
 *  <li>功能
 * <ul>
 *  <li> http://apache.org/xml/features/validation/schema </li> <li> http://apache.org/xml/features/vali
 * dation/schema-full-checking </li> <li > http://apache.org/xml/features/validation/schema/normalized-v
 * alue </li> <li> http://apache.org/xml/features/validation/schema/element-default </li>。
 * </ul>
 *  <li>属性
 * <ul>
 * <li> http://apache.org/xml/properties/internal/error-reporter </li> <li> http://apache.org/xml/proper
 * ties/internal/entity-manager </li> <li > http://apache.org/xml/properties/internal/document-scanner </li>
 *  <li> http://apache.org/xml/properties/internal/dtd-scanner </li> <li> HTTP ：//apache.org/xml/propert
 * ies/internal/grammar-pool </li> <li> http://apache.org/xml/properties/internal/validator/dtd </li> <li>
 *  HTTP：/ /apache.org/xml/properties/internal/datatype-validator-factory </li>。
 * </ul>
 * </ul>
 * 
 * 
