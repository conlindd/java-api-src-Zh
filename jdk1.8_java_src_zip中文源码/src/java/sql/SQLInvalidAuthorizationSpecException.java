 ...
 * <p>
 *  当SQLState类值为'<i> 28 </i>'或在供应商指定的条件下时抛出的{@link SQLException}子类。这表示在连接建立期间显示的授权凭证无效。
 * <p>
...
public class SQLInvalidAuthorizationSpecException extends SQLNonTransientException {
         ...
         * <p>
         * <p>
         *  构造<code> SQLInvalidAuthorizationSpecException </code>对象。
         ...
         * <p>
         * <p>
         *  构造具有给定<code>原因</code>的<code> SQLInvalidAuthorizationSpecException </code>对象。
         ...
         * <p>
         * <p>
         *  用给定的<code> reason </code>和<code> SQLState </code>构造一个<code> SQLInvalidAuthorizationSpecException </code>
         * 对象。
         * 
         * <code> cause </code>没有被初始化,并且随后可以通过调用{@link Throwable#initCause(java.lang.Throwable)}方法来初始化。
         * 供应商代码初始化为0。
         ...
         * <p>
         * <p>
         *  构造具有给定<code>原因</code>,<code> SQLState </code>和<code> vendorCode </code>的<code> SQLInvalidAuthorizati
         * onSpecException </code>对象。
         * 
         *  <code> cause </code>没有被初始化,并且随后可以通过调用{@link Throwable#initCause(java.lang.Throwable)}方法来初始化。
         * <p>
         * 
     ...
     * <p>
     * <p>
     *  构造具有给定<code>原因</code>和<code>原因</code>的<code> SQLInvalidAuthorizationSpecException </code>对象。
     *  <code> SQLState </code>初始化为<code> null </code>,供应商代码初始化为0。
     * <p>
     * 
     * @param reason a description of the exception.
     ...
     * <p>
     * <p>
     *  构造具有给定<code>原因</code>,<code> SQLState </code>和<code>原因</code>的<code> SQLInvalidAuthorizationSpecExce
     * ption </code>对象。
     * 供应商代码初始化为0。
     * <p>
     * 
