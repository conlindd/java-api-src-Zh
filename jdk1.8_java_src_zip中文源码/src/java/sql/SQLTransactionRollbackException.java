 ...
 * <p>
 *  当SQLState类值为"<i> 40 </i>"时或在供应商指定的条件下抛出的{@link SQLException}子类。这表示由于死锁或其他事务序列化失败,当前语句由数据库自动回滚。
 * <p>
...
public class SQLTransactionRollbackException extends SQLTransientException {
         ...
         * <p>
         * <p>
         *  用给定的<code> reason </code>构造一个<code> SQLTransactionRollbackException </code>对象。
         ...
         * <p>
         * <p>
         *  使用给定的<code> reason </code>和<code> SQLState </code>构造一个<code> SQLTransactionRollbackException </code>
         * 对象。
         * 
         * <code> cause </code>没有被初始化,并且随后可以通过调用{@link Throwable#initCause(java.lang.Throwable)}方法来初始化。
         * 供应商代码初始化为0。
         ...
         * <p>
         * <p>
         *  构造具有给定<code>原因</code>,<code> SQLState </code>和<code> vendorCode </code>的<code> SQLTransactionRollbac
         * kException </code>对象。
         * 
         *  <code> cause </code>没有被初始化,并且随后可以通过调用{@link Throwable#initCause(java.lang.Throwable)}方法来初始化。
         * <p>
     ...
     * <p>
     * <p>
     *  用给定的<code> cause </code>构造一个<code> SQLTransactionRollbackException </code>对象。
     ...
     * <p>
     * <p>
     *  构造具有给定<code>原因</code>和<code>原因</code>的<code> SQLTransactionRollbackException </code>对象。
     *  <code> SQLState </code>初始化为<code> null </code>,供应商代码初始化为0。
     * <p>
     * 
     * @param reason a description of the exception.
     ...
     * <p>
     * <p>
     *  构造具有给定<code>原因</code>,<code> SQLState </code>和<code>原因</code>的<code> SQLTransactionRollbackException
     *  </code>对象。
     * 供应商代码初始化为0。
     * <p>
     * 
