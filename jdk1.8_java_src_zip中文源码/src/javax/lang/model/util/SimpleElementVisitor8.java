 ...
 *
 * <p>
 *  一个简单的程序元素访问者,其默认行为适合{@link SourceVersion#RELEASE_8 RELEASE_8}源版本。
 * 
 *  访问与{@code RELEASE_7}和早期语言结构对应的方法,调用{@link #defaultAction defaultAction},将其参数传递给{@code defaultAction}
 * 的相应参数。
 * 
