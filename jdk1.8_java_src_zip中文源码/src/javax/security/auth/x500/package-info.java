 ...
 *
 * <p>
 *  此程序包包含应用于将X500 Principal和X500私有凭据存储在<i>主题</i>中的类。
 * 
 *  <h2>包规格</h2>
 * 
 * <ul>
 *  <li> <a href="http://www.ietf.org/rfc/rfc1779.txt"> RFC 1779：可辨认名称的字符串表示</a> </li> <li> <a href =" http://www.ietf.org/rfc/rfc2253.txt">
 * 
 * @since JDK1.4
 */
