 ...
 *
 * <p>
 *  用于组合<code> FileChooserUI </code>的复用UI。
 * 
 *  <p>此文件由AutoMulti自动生成。
 * 
 * 
...
////////////////////
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> getAcceptAllFileFilter </code>方法。
     * 
     * 
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> getFileView </code>方法。
     * 
     * 
     * @return the value obtained from the first UI, which is
     * the UI obtained from the default <code>LookAndFeel</code>
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> getApproveButtonText </code>方法。
     * 
     * 
     * @return the value obtained from the first UI, which is
     * the UI obtained from the default <code>LookAndFeel</code>
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> getDialogTitle </code>方法。
     * 
     * 
     * @return the value obtained from the first UI, which is
     * the UI obtained from the default <code>LookAndFeel</code>
     ...
     * <p>
     *  在此对象处理的每个UI上调用<code> rescanCurrentDirectory </code>方法。
     * 
     */
     ...
     * <p>
     *  在此对象处理的每个UI上调用<code> ensureFileIsVisible </code>方法。
     * 
     */
