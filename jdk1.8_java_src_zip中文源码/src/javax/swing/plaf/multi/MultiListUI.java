...
////////////////////
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> locationToIndex </code>方法。
     * 
     * 
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> indexToLocation </code>方法。
     * 
     * 
     * @return the value obtained from the first UI, which is
     * the UI obtained from the default <code>LookAndFeel</code>
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> getCellBounds </code>方法。
     * 
     * 
     * @return the value obtained from the first UI, which is
     * the UI obtained from the default <code>LookAndFeel</code>
