 ...
 *
 * <p>
 *  用于组合<code> SplitPaneUI </code>的复用UI。
 * 
 *  <p>此文件由AutoMulti自动生成。
 * 
 * 
...
////////////////////
     ...
     * <p>
     *  在此对象处理的每个UI上调用<code> resetToPreferredSizes </code>方法。
     * 
     */
     ...
     * <p>
     *  在此对象处理的每个UI上调用<code> setDividerLocation </code>方法。
     * 
     */
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> getDividerLocation </code>方法。
     * 
     * 
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> getMinimumDividerLocation </code>方法。
     * 
     * 
     * @return the value obtained from the first UI, which is
     * the UI obtained from the default <code>LookAndFeel</code>
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> getMaximumDividerLocation </code>方法。
     * 
     * 
     * @return the value obtained from the first UI, which is
     * the UI obtained from the default <code>LookAndFeel</code>
     ...
     * <p>
     *  在此对象处理的每个UI上调用<code> finishedPaintingChildren </code>方法。
     * 
     */
