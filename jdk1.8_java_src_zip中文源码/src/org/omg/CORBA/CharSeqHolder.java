...
* <p>
*  <tt> CharSeq </tt>的持有人。
* 有关Holder文件的详细信息,请参阅<a href="doc-files/generatedfiles.html#holder">"生成的文件：持有人文件"</a>。
* <P> org / omg / CORBA / CharSeqHolder.java生成者IDL到Java编译器(portable),版本"3.0"from streams.idl 13 May 199
*/
