 ...
 * <p>
 *  文件：./org/omg/CORBA/PRIVATE_MEMBER.java From：./ir.idl日期：Fri Aug 28 16:03:31 1998发布者：idltojava Java ID
 * L 1.2 Aug 11 1998 02:00:18。
 * 
 */
 ...
 *
 * <p>
 *  在<code> ValueMember </code>类中定义一个私有成员的常量。
 * <P>
 *  <code> PRIVATE_MEMBER </code>是接口存储库中用于标识<code> ValueMember </code>类型的可见性的typedef <code> Visibility </code>
 * 
 * @author unattributed
 */
