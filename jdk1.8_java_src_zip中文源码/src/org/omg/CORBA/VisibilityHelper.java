...
* <p>
*  <tt>可见性助手</tt>。有关帮助文件的详细信息,请参阅<a href="doc-files/generatedfiles.html#helper">"生成的文件：帮助程序文件"</a>。
* <P> org / omg / CORBA / VisibilityHelper.java生成者IDL到Java编译器(portable),版本"3.0"from ir.idl 03六月1999 11:
* 33:44 GMT + 00：00。
*/
