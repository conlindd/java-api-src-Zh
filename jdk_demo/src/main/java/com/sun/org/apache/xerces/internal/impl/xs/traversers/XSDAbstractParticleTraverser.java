...
abstract class XSDAbstractParticleTraverser extends XSDAbstractTraverser {
     ...
     *  遍历"全部"声明
     * 
     *  &lt; all id = ID maxOccurs = 1：1 minOccurs =(0 | 1)：1&gt;内容：(annotation?,element *)&lt; / all&gt;
     * 
     * 
     **/
     ...
     *  遍历序列声明
     * 
     *  <sequence id = ID maxOccurs = string
     * minOccurs = nonNegativeInteger>
     *  内容：(注释?,(element | group | choice | sequence | any)*)
     * </sequence>
     * 
     * 
     * @param seqDecl
