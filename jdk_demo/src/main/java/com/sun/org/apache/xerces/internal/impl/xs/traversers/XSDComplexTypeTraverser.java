 ...
 *  复杂类型定义模式组件遍历器。
 * 
 *  <complexType abstract = boolean：false block =(#all | List of(extension | restriction))final =(#all | List of(extension | restriction))id = ID mixed = boolean：false name = NCName。
 * {any attributes with non-schema namespace . . .}>
 *  内容：(annotation?,(simpleContent | complexContent |((group | all | choice | sequence)?,((attribute | a
 * ttributeGroup)*,anyAttribute?))))。
 * </complexType>
 * 
 *  @ xerces.internal
 * 
