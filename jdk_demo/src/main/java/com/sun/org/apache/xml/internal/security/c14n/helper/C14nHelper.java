...
public class C14nHelper {
     ...
     *
     * <p>
     *  如果所提供的Document无法使用TreeWalker遍历,则此方法会抛出CanonicalizationException。
     * 
     * 
     * @param document
     * @throws CanonicalizationException
     ...
     *
     * <p>
     *  如果提供的Element包含任何相对命名空间,此方法将抛出CanonicalizationException。
     * 
     * @param ctxNode
     * @throws CanonicalizationException
