 ...
 * <p>
 *  当SQLState类值为"<i> 23 </i>"时或在供应商指定的条件下时抛出的{@link SQLException}子类。这表示已违反完整性约束(外键,主键或唯一键)。
 * <p>
...
public class SQLIntegrityConstraintViolationException extends SQLNonTransientException {
         ...
         * <p>
         * <p>
         *  构造一个<code> SQLIntegrityConstraintViolationException </code>对象。
         ...
         * <p>
         * <p>
         *  使用给定的<code> reason </code>构造一个<code> SQLIntegrityConstraintViolationException </code>。
         ...
         * <p>
         * <p>
         *  使用给定的<code> reason </code>和<code> SQLState </code>构造<code> SQLIntegrityConstraintViolationException 
         * </code>对象。
         * 
         * <code> cause </code>没有被初始化,并且随后可以通过调用{@link Throwable#initCause(java.lang.Throwable)}方法来初始化。
         * 供应商代码初始化为0。
         ...
         * <p>
         * <p>
         *  构造具有给定<code>原因</code>,<code> SQLState </code>和<code> vendorCode </code>的<code> SQLIntegrityConstrain
         * tViolationException </code>对象。
         * 
         *  <code> cause </code>没有被初始化,并且随后可以通过调用{@link Throwable#initCause(java.lang.Throwable)}方法来初始化。
         * <p>
         * 
     ...
     * <code>cause!=null</code>.
         * <p>
         * <p>
         *  构造具有给定<code>原因</code>的<code> SQLIntegrityConstraintViolationException </code>对象。
     ...
     * <p>
     * <p>
     *  构造具有给定<code>原因</code>和<code>原因</code>的<code> SQLIntegrityConstraintViolationException </code>对象。
     *  <code> SQLState </code>初始化为<code> null </code>,供应商代码初始化为0。
     * <p>
     * 
     * @param reason a description of the exception.
     ...
     * <p>
     * <p>
     *  构造具有给定<code>原因</code>,<code> SQLState </code>和<code>原因</code>的<code> SQLIntegrityConstraintViolation
     * Exception </code>对象。
     * 供应商代码初始化为0。
     * <p>
     * 
