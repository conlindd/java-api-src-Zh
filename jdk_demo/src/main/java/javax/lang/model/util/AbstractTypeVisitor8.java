 ...
 *
 * <p>
 *  适用于{@link javax.lang.model.SourceVersion#RELEASE_8 RELEASE_8}源版本的默认行为的类型的骨架访问者。
 * 
 *  <p> <b>警告：</b>此类别实施的{@code TypeVisitor}接口可能会在未来添加方法,以容纳添加到未来版本的Java和贸易中的新的,当前未知的语言结构;编程语言。
