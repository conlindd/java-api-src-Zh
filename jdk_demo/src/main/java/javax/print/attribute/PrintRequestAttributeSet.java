 ...
 *
 * <p>
 *  接口PrintRequestAttributeSet指定一组打印请求属性的接口,即实现接口{@link PrintRequestAttribute PrintRequestAttribute}的打印属
 * 性。
 * 客户端使用PrintRequestAttributeSet指定要应用于整个打印作业和打印作业中的所有文档的设置。
 * <P>
 *  PrintRequestAttributeSet只是一个{@link AttributeSet AttributeSet},其构造函数和变异操作保证了一个额外的不变量,即PrintRequestAtt
 * ributeSet中的所有属性值必须是interface {@link PrintRequestAttribute PrintRequestAttribute}的实例。
