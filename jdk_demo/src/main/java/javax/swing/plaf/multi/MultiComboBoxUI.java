 ...
 *
 * <p>
 *  用于组合<code> ComboBoxUI </code>的复用UI。
 * 
 *  <p>此文件由AutoMulti自动生成。
 * 
 * 
...
////////////////////
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> isFocusTraversable </code>方法。
     * 
     * 
     ...
     * <p>
     *  在此对象处理的每个UI上调用<code> setPopupVisible </code>方法。
     * 
     */
     ...
     *
     * <p>
     *  在此对象处理的每个UI上调用<code> isPopupVisible </code>方法。
     * 
     * 
     * @return the value obtained from the first UI, which is
     * the UI obtained from the default <code>LookAndFeel</code>
