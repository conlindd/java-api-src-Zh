...
* <p>
*  <tt> FieldName </tt>的帮助器。
* 有关帮助文件的详细信息,请参阅<a href="doc-files/generatedfiles.html#helper">"生成的文件：帮助文件"</a>。
* <P> org / omg / CORBA / FieldNameHelper.java生成者IDL到Java编译器(portable),版本"3.0"1999年6月03日11:52:03 GMT + 
*/
