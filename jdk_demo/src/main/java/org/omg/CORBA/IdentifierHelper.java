...
* <p>
*  <tt>标识符</tt>的帮助器。有关帮助文件的详细信息,请参见<a href="doc-files/generatedfiles.html#helper">"生成的文件：帮助程序文件"</a>。
* <P> org / omg / CORBA / IdentifierHelper.java生成者IDL到Java编译器(portable),版本"3.0"from ir.idl 03 June 1999
*  11:33:42 o GMT GMT + 00：00。
*/
