 ...
 * <p>
 *  将名称与作为IDL结构的属性的值相关联,并在<tt> DynStruct </tt> API中使用。
 * 
 */
...
public final class NameValuePair implements org.omg.CORBA.portable.IDLEntity {
     ...
     * <p>
     *  通过此<code> NameValuePair </code>对象与值相关联的名称。
     * 
     */
    public String id;
     ...
     * <p>
     *  通过此<code> NameValuePair </code>对象与名称相关联的值。
     * 
     */
     ...
     * <p>
     *  构造一个空的<code> NameValuePair </code>对象。要在使用此构造函数后将名称与值关联,必须单独访问此对象的字段。
     * 
     */
     ...
     * <p>
     *  构造一个将给定的名称与给定的<code> org.omg.CORBA.Any </code>对象相关联的<code> NameValuePair </code>对象。
     * 
