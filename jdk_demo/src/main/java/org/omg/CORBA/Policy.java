...
* <p>
*  从<tt> Policy </tt>接口派生的接口允许ORB或CORBA服务访问影响其操作的某些选项。
* 使用从CORBA模块中定义的<tt> Policy </tt>接口派生的接口以结构化方式访问此信息。 CORBA服务不必使用此方法访问操作选项,但可以选择这样做。
* 安全服务特别使用此技术将安全策略与系统中的对象相关联。由IDL到Java编译器生成的接口。
*  org / omg / CORBA / Policy.java由IDL到Java编译器(portable)生成的版本"3.0",来自../../../../../src/share/classes/o
*/
