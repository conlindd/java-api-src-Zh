...
* <p>
*  <tt> IDLType </tt>的存根。有关存根文件的详细信息,请参见<a href="doc-files/generatedfiles.html#stub">"生成的文件：存根"</a>。
* <P> org / omg / CORBA / _IDLTypeStub.java由IDL到Java编译器(可移植),版本"3.0"从ir.idl。
*  1999年6月3日上午11:33:44 GMT + 00：00。
* 
*/
...
public class _IDLTypeStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.IDLType
{
   ...
   *        has been called.
   * <p>
   *  构造一个默认的<code> _IDLTypeStub </code>对象。注意：如果使用默认构造函数,对象在调用<code> _set_delegate </code>方法之前是无用的。
   * 
   */
   ...
   *
   * <p>
   *  构造使用给定的<code> Delegate </code>对象初始化的<code> _IDLTypeStub </code>对象。
   * 
