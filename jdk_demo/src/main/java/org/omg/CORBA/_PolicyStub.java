...
* <p>
*  <tt>策略的存根</tt>。有关存根文件的详细信息,请参见<a href="doc-files/generatedfiles.html#stub">"生成的文件：存根"</a>。
* <P> org / omg / CORBA / _PolicyStub.java由IDL到Java编译器(便携式),来自../../../../../src/share/classes/org/omg/
* PortableServer/corba.idl的版本"3.0"。
*  <tt>策略的存根</tt>。有关存根文件的详细信息,请参见<a href="doc-files/generatedfiles.html#stub">"生成的文件：存根"</a>。
*  1999年7月17日星期六12:26:20 PDT。
* 
*/
...
public class _PolicyStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.Policy
{
   ...
   *        is called.
   * <p>
   *  注意：如果使用默认构造函数,该对象是无用的,直到调用_set_delegate(...)。
   * 
   */
  public _PolicyStub ()
  {
  ...
  /** Returns the constant value that corresponds to the
                ...
                * <p>
                *  类型的策略对象。 polivy对象的值由OMG分配。 PolicyType的新值应通过发送邮件至request@omg.org从OMG获取。通常,分配的常量值与相应策略对象的定义结合定义。
                * 
                * 
